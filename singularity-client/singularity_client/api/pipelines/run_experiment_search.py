...
from ...models.experiment_search_request import ExperimentSearchRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/internal/mcp/users/me/pipelines/experiment-search",
    }
...
def sync_detailed(
    *,
    ...
    """Run Experiment Search Endpoint
