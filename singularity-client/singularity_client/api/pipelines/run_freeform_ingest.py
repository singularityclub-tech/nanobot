...
from ...models.freeform_ingest_request import FreeformIngestRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/internal/mcp/users/me/pipelines/freeform-ingest",
    }
