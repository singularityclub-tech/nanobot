...
from ...models.get_panel_table_response_get_panel_table import GetPanelTableResponseGetPanelTable
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/internal/users/me/panels/{panel}/table".format(
...
) -> GetPanelTableResponseGetPanelTable | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = GetPanelTableResponseGetPanelTable.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetPanelTableResponseGetPanelTable | HTTPValidationError]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get User Panel Table

     Pivoted signal × window table; suitable for grid/spreadsheet rendering.
...
def sync(
    ...
    *,
    ...
    Returns:
        GetPanelTableResponseGetPanelTable | HTTPValidationError
    """
