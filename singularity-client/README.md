...
```python
from singularity_client import Client
...
```python
from singularity_client import AuthenticatedClient
...
```python
from singularity_client.models import MyDataModel
from singularity_client.api.my_tag import get_my_data_model
from singularity_client.types import Response
...
1. Any endpoint which did not have a tag will be in `singularity_client.api.default`
